...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	ArrayList<CommentTO> lists = dao.commentList(comTo);
	...
	for( CommentTO list : lists ){
		...
		strHtml.append("<a href='board_view1.jsp?cpage="+ cpage +"&seq=" + seq +"&cSeq=" + cSeq +"&mode=" + "mod" +"'>수정</a>");
		strHtml.append("&nbsp");
		strHtml.append("<a href='board_view1.jsp?cpage="+ cpage +"&seq=" + seq +"&cSeq=" + cSeq +"&mode=" + "del" +"'>삭제</a>");
		...
		<div class="board_view">
			...
			<%=strHtml %>
				...
				<%
					...
					if(request.getParameter("cSeq") != null && mode.equals("mod")){
						...
						String uWriter = "";
						String uContent = "";
						for(CommentTO list : uLists){
							uSeq = list.getSeq();
							uWriter = list.getWriter();
							uContent = list.getContent();
						}
						
				%>
				<form action="./comment_modify_ok.jsp" method="post" name="cfrm">
				...
				<%
						...
						String dSeq = dComTo.getSeq();
						String dWriter = dComTo.getWriter();
						String dContent = dComTo.getContent();
				...
				%>
				<form action="./comment_ok.jsp" method="post" name="cfrm">
					<input type="hidden" name="seq" value="<%=seq %>" />
					<input type="hidden" name="cpage" value="<%=cpage %>" />
