	...
	<input type="hidden" name="cpage" value="<%=cpage %>" />
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th>제목</th>
					<td colspan="3"><input type="text" name="subject" value="<%=subject %>" class="board_write_input" readonly/></td>
				</tr>
				<tr>
					<th>비밀번호</th>
			...
			<div class="btn_area">
				<div class="align_left">			
					<input type="button" value="목록" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='list.do?cpage=<%=cpage %>&seq=<%=seq %>'" />
